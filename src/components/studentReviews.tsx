...
const data = [
  {
    ...
    faadback: "A wonderful, healthy pastime! Great, exciting and giving hope for a full perception of the world in its best light! Developing motor skills-we develop acute and quick problem solving! Great! Thanks!",
  ...
  },
  {
    ...
    faadback: "Now I feel my inner power After this program I does not feel my daily weakness without taking any pills and medications. This is unbelieveble!",
  ...
  },
  {
    ...
    faadback: "Hello. Thank you so much for the course program!!! It was a pleasure, I liked everything very much!!! The result speaks better than any words!",
  ...
  },
  {
    ...
    faadback: "I've been doing it for 2 months, 3 times a week - the result is minus 8 cm in the waistline. Very cool result! Thank you for this useful course.",
